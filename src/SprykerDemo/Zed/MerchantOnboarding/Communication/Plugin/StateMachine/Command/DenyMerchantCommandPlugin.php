 ...
 */
class DenyMerchantCommandPlugin extends AbstractMerchantOnboardingStateMachineCommandPlugin
{
    /**
     * @uses {@link \Spryker\Zed\MerchantGui\MerchantGuiConfig::STATUS_DENIED}
     *
     * @var string
     */
    ...
    /**
     * {@inheritDoc}
     * - Sets `denied` onboarding status for a merchant related to the state machine item.
     *
     * @api
     *
    ...
    {
        $merchantTransfer->setStatus(static::STATUS_DENIED);
